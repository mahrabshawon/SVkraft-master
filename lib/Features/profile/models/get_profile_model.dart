...
class GetProfileDetailsData {
  ...
  @override
  String toString() {
    return 'GetProfileDetailsData{id: $id, image: $image, name: $name, username: $username, email: $email, phone: $phone, phoneVerified: $phoneVerified, dateOfBirth: $dateOfBirth, gender: $gender,location: $location';
  }
}
